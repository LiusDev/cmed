...
const Footer = () => {
    ...
    return (
        <>
            ...
            <ChatZaloFloatingButton
                userId={metadata?.companyPhone || "0886099866"}
                className="bottom-[45px]"
            />
                        ...
                        <div className="flex flex-col lg:flex-row lg:items-center gap-6 lg:gap-8 order-1 lg:order-2 mb-8 lg:mb-0">
                            ...
                            <div>
                                <h5 className="uppercase mb-4 lg:mb-6">
                                    {
                                        metadata?.[
                                            `companyName${currentLang}` as keyof typeof metadata
                                        ]
                                    }
                                </h5>
                                <p className="text-sm font-light">
                                    {
                                        metadata?.[
                                            `companyAddress${currentLang}` as keyof typeof metadata
                                        ]
                                    }
                                </p>
                            </div>
