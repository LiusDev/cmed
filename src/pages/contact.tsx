...
const ContactInfo = () => {
    ...
    const metadata: Metadata = doGet("/metadata").data
    const data: { [key: string]: string } = {}
    data[t("contact.company")] = metadata.companyName
    data[t("contact.hotline")] = metadata.companyPhone
    data[t("contact.email")] = metadata.companyPhone
    data[t("contact.address")] = metadata.companyAddress
