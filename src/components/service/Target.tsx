    ...
    return (
        <div className="px-72 bg-primary-light py-28 flex justify-center items-center">
            <div className="w-1/2 px-10 space-y-5">
                <h1 className="text-2xl text-primary font-bold"><Trans text="services.target.header" /></h1>
                <p className="text-justify text-sm"><Trans text="services.target.content" /></p>
            </div>
