  ...
  return (
    <MainLayout>
      ...
      <div className="container m-auto px-4 mt-28">
        <div className="pb-20 mb-20 border-b border-tertiary/20 flex items-center">
          <div className="w-1/2 px-5">
            <img src={project.featuredImage} alt="project-image" />
          </div>
          <div className="w-1/2 px-5">
            <h1 className="text-xl font-bold">1. Tổng quan về dự án</h1>
            <p>{parse(project.content)}</p>
          </div>
        </div>
